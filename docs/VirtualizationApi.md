...
> VirtualizationClusterGroupsBulkDestroy(ctx).Execute()
...
func main() {
    ...
    resp, r, err := apiClient.VirtualizationApi.VirtualizationClusterGroupsBulkDestroy(context.Background()).Execute()
    if err != nil {
...
> ClusterGroup VirtualizationClusterGroupsBulkPartialUpdate(ctx).PatchedClusterGroup(patchedClusterGroup).Execute()
...
func main() {
    patchedClusterGroup := *openapiclient.NewPatchedClusterGroup() // PatchedClusterGroup |  (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.VirtualizationApi.VirtualizationClusterGroupsBulkPartialUpdate(context.Background()).PatchedClusterGroup(patchedClusterGroup).Execute()
    if err != nil {
...
------------- | ------------- | ------------- | -------------
 **patchedClusterGroup** | [**PatchedClusterGroup**](PatchedClusterGroup.md) |  | 
...
> ClusterGroup VirtualizationClusterGroupsBulkUpdate(ctx).ClusterGroup(clusterGroup).Execute()
...
func main() {
    clusterGroup := *openapiclient.NewClusterGroup("Id_example", "Url_example", "Name_example", int32(123), "Display_example") // ClusterGroup | 

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.VirtualizationApi.VirtualizationClusterGroupsBulkUpdate(context.Background()).ClusterGroup(clusterGroup).Execute()
    if err != nil {
...
> ClusterGroup VirtualizationClusterGroupsCreate(ctx).ClusterGroup(clusterGroup).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.VirtualizationApi.VirtualizationClusterGroupsCreate(context.Background()).ClusterGroup(clusterGroup).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.VirtualizationApi.VirtualizationClusterGroupsDestroy(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.VirtualizationApi.VirtualizationClusterGroupsList(context.Background()).Created(created).CreatedGte(createdGte).CreatedLte(createdLte).Description(description).DescriptionIc(descriptionIc).DescriptionIe(descriptionIe).DescriptionIew(descriptionIew).DescriptionIre(descriptionIre).DescriptionIsw(descriptionIsw).DescriptionN(descriptionN).DescriptionNic(descriptionNic).DescriptionNie(descriptionNie).DescriptionNiew(descriptionNiew).DescriptionNire(descriptionNire).DescriptionNisw(descriptionNisw).DescriptionNre(descriptionNre).DescriptionRe(descriptionRe).Id(id).IdIc(idIc).IdIe(idIe).IdIew(idIew).IdIre(idIre).IdIsw(idIsw).IdN(idN).IdNic(idNic).IdNie(idNie).IdNiew(idNiew).IdNire(idNire).IdNisw(idNisw).IdNre(idNre).IdRe(idRe).LastUpdated(lastUpdated).LastUpdatedGte(lastUpdatedGte).LastUpdatedLte(lastUpdatedLte).Limit(limit).Name(name).NameIc(nameIc).NameIe(nameIe).NameIew(nameIew).NameIre(nameIre).NameIsw(nameIsw).NameN(nameN).NameNic(nameNic).NameNie(nameNie).NameNiew(nameNiew).NameNire(nameNire).NameNisw(nameNisw).NameNre(nameNre).NameRe(nameRe).Offset(offset).Q(q).Slug(slug).SlugIc(slugIc).SlugIe(slugIe).SlugIew(slugIew).SlugIre(slugIre).SlugIsw(slugIsw).SlugN(slugN).SlugNic(slugNic).SlugNie(slugNie).SlugNiew(slugNiew).SlugNire(slugNire).SlugNisw(slugNisw).SlugNre(slugNre).SlugRe(slugRe).Execute()
    if err != nil {
...
> ClusterGroup VirtualizationClusterGroupsPartialUpdate(ctx, id).PatchedClusterGroup(patchedClusterGroup).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.VirtualizationApi.VirtualizationClusterGroupsPartialUpdate(context.Background(), id).PatchedClusterGroup(patchedClusterGroup).Execute()
    if err != nil {
...
> ClusterGroup VirtualizationClusterGroupsUpdate(ctx, id).ClusterGroup(clusterGroup).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.VirtualizationApi.VirtualizationClusterGroupsUpdate(context.Background(), id).ClusterGroup(clusterGroup).Execute()
    if err != nil {
...
> VirtualizationClusterTypesBulkDestroy(ctx).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.VirtualizationApi.VirtualizationClusterTypesBulkDestroy(context.Background()).Execute()
    if err != nil {
...
> ClusterType VirtualizationClusterTypesBulkPartialUpdate(ctx).PatchedClusterType(patchedClusterType).Execute()
...
func main() {
    patchedClusterType := *openapiclient.NewPatchedClusterType() // PatchedClusterType |  (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.VirtualizationApi.VirtualizationClusterTypesBulkPartialUpdate(context.Background()).PatchedClusterType(patchedClusterType).Execute()
    if err != nil {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **patchedClusterType** | [**PatchedClusterType**](PatchedClusterType.md) |  | 
...
> ClusterType VirtualizationClusterTypesBulkUpdate(ctx).ClusterType(clusterType).Execute()
...
func main() {
    clusterType := *openapiclient.NewClusterType("Id_example", "Url_example", "Name_example", int32(123), time.Now(), time.Now(), "Display_example") // ClusterType | 

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.VirtualizationApi.VirtualizationClusterTypesBulkUpdate(context.Background()).ClusterType(clusterType).Execute()
    if err != nil {
...
> ClusterType VirtualizationClusterTypesCreate(ctx).ClusterType(clusterType).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.VirtualizationApi.VirtualizationClusterTypesCreate(context.Background()).ClusterType(clusterType).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.VirtualizationApi.VirtualizationClusterTypesDestroy(context.Background(), id).Execute()
    if err != nil {
...
> PaginatedClusterTypeList VirtualizationClusterTypesList(ctx).Created(created).CreatedGte(createdGte).CreatedLte(createdLte).Description(description).DescriptionIc(descriptionIc).DescriptionIe(descriptionIe).DescriptionIew(descriptionIew).DescriptionIre(descriptionIre).DescriptionIsw(descriptionIsw).DescriptionN(descriptionN).DescriptionNic(descriptionNic).DescriptionNie(descriptionNie).DescriptionNiew(descriptionNiew).DescriptionNire(descriptionNire).DescriptionNisw(descriptionNisw).DescriptionNre(descriptionNre).DescriptionRe(descriptionRe).Id(id).IdIc(idIc).IdIe(idIe).IdIew(idIew).IdIre(idIre).IdIsw(idIsw).IdN(idN).IdNic(idNic).IdNie(idNie).IdNiew(idNiew).IdNire(idNire).IdNisw(idNisw).IdNre(idNre).IdRe(idRe).LastUpdated(lastUpdated).LastUpdatedGte(lastUpdatedGte).LastUpdatedLte(lastUpdatedLte).Limit(limit).Name(name).NameIc(nameIc).NameIe(nameIe).NameIew(nameIew).NameIre(nameIre).NameIsw(nameIsw).NameN(nameN).NameNic(nameNic).NameNie(nameNie).NameNiew(nameNiew).NameNire(nameNire).NameNisw(nameNisw).NameNre(nameNre).NameRe(nameRe).Offset(offset).Q(q).Slug(slug).SlugIc(slugIc).SlugIe(slugIe).SlugIew(slugIew).SlugIre(slugIre).SlugIsw(slugIsw).SlugN(slugN).SlugNic(slugNic).SlugNie(slugNie).SlugNiew(slugNiew).SlugNire(slugNire).SlugNisw(slugNisw).SlugNre(slugNre).SlugRe(slugRe).Execute()
...
> ClusterType VirtualizationClusterTypesPartialUpdate(ctx, id).PatchedClusterType(patchedClusterType).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.VirtualizationApi.VirtualizationClusterTypesPartialUpdate(context.Background(), id).PatchedClusterType(patchedClusterType).Execute()
    if err != nil {
...
> ClusterType VirtualizationClusterTypesUpdate(ctx, id).ClusterType(clusterType).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.VirtualizationApi.VirtualizationClusterTypesUpdate(context.Background(), id).ClusterType(clusterType).Execute()
    if err != nil {
...
> VirtualizationClustersBulkDestroy(ctx).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.VirtualizationApi.VirtualizationClustersBulkDestroy(context.Background()).Execute()
    if err != nil {
...
> Cluster VirtualizationClustersBulkPartialUpdate(ctx).PatchedWritableCluster(patchedWritableCluster).Execute()
...
func main() {
    patchedWritableCluster := *openapiclient.NewPatchedWritableCluster() // PatchedWritableCluster |  (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.VirtualizationApi.VirtualizationClustersBulkPartialUpdate(context.Background()).PatchedWritableCluster(patchedWritableCluster).Execute()
    if err != nil {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **patchedWritableCluster** | [**PatchedWritableCluster**](PatchedWritableCluster.md) |  | 
...
> Cluster VirtualizationClustersBulkUpdate(ctx).WritableCluster(writableCluster).Execute()
...
func main() {
    writableCluster := *openapiclient.NewWritableCluster("Id_example", "Url_example", "Name_example", "Type_example", time.Now(), time.Now(), int32(123), int32(123), map[string]interface{}{"key": interface{}(123)}, "Display_example") // WritableCluster | 

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.VirtualizationApi.VirtualizationClustersBulkUpdate(context.Background()).WritableCluster(writableCluster).Execute()
    if err != nil {
...
> Cluster VirtualizationClustersCreate(ctx).WritableCluster(writableCluster).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.VirtualizationApi.VirtualizationClustersCreate(context.Background()).WritableCluster(writableCluster).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.VirtualizationApi.VirtualizationClustersDestroy(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    groupId := []*string{"Inner_example"} // []*string | Parent group (ID) (optional)
    groupIdN := []*string{"Inner_example"} // []*string | Parent group (ID) (optional)
    id := []string{"Inner_example"} // []string |  (optional)
    idIc := []string{"Inner_example"} // []string |  (optional)
    idIe := []string{"Inner_example"} // []string |  (optional)
    idIew := []string{"Inner_example"} // []string |  (optional)
    ...
    typeId := []string{"Inner_example"} // []string | Cluster type (ID) (optional)
    typeIdN := []string{"Inner_example"} // []string | Cluster type (ID) (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.VirtualizationApi.VirtualizationClustersList(context.Background()).Created(created).CreatedGte(createdGte).CreatedLte(createdLte).Group(group).GroupN(groupN).GroupId(groupId).GroupIdN(groupIdN).Id(id).IdIc(idIc).IdIe(idIe).IdIew(idIew).IdIre(idIre).IdIsw(idIsw).IdN(idN).IdNic(idNic).IdNie(idNie).IdNiew(idNiew).IdNire(idNire).IdNisw(idNisw).IdNre(idNre).IdRe(idRe).LastUpdated(lastUpdated).LastUpdatedGte(lastUpdatedGte).LastUpdatedLte(lastUpdatedLte).Limit(limit).Name(name).NameIc(nameIc).NameIe(nameIe).NameIew(nameIew).NameIre(nameIre).NameIsw(nameIsw).NameN(nameN).NameNic(nameNic).NameNie(nameNie).NameNiew(nameNiew).NameNire(nameNire).NameNisw(nameNisw).NameNre(nameNre).NameRe(nameRe).Offset(offset).Q(q).Region(region).RegionN(regionN).RegionId(regionId).RegionIdN(regionIdN).Site(site).SiteN(siteN).SiteId(siteId).SiteIdN(siteIdN).Tag(tag).TagN(tagN).Tenant(tenant).TenantN(tenantN).TenantGroup(tenantGroup).TenantGroupN(tenantGroupN).TenantGroupId(tenantGroupId).TenantGroupIdN(tenantGroupIdN).TenantId(tenantId).TenantIdN(tenantIdN).Type_(type_).TypeN(typeN).TypeId(typeId).TypeIdN(typeIdN).Execute()
    if err != nil {
 ...
 **groupIdN** | **[]string** | Parent group (ID) | 
 **id** | **[]string** |  | 
 **idIc** | **[]string** |  | 
 **idIe** | **[]string** |  | 
 **idIew** | **[]string** |  | 
 ...
 **typeId** | **[]string** | Cluster type (ID) | 
 **typeIdN** | **[]string** | Cluster type (ID) | 
...
> Cluster VirtualizationClustersPartialUpdate(ctx, id).PatchedWritableCluster(patchedWritableCluster).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.VirtualizationApi.VirtualizationClustersPartialUpdate(context.Background(), id).PatchedWritableCluster(patchedWritableCluster).Execute()
    if err != nil {
...
> Cluster VirtualizationClustersUpdate(ctx, id).WritableCluster(writableCluster).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.VirtualizationApi.VirtualizationClustersUpdate(context.Background(), id).WritableCluster(writableCluster).Execute()
    if err != nil {
...
> VirtualizationInterfacesBulkDestroy(ctx).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.VirtualizationApi.VirtualizationInterfacesBulkDestroy(context.Background()).Execute()
    if err != nil {
...
> VMInterface VirtualizationInterfacesBulkPartialUpdate(ctx).PatchedWritableVMInterface(patchedWritableVMInterface).Execute()
...
func main() {
    patchedWritableVMInterface := *openapiclient.NewPatchedWritableVMInterface() // PatchedWritableVMInterface |  (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.VirtualizationApi.VirtualizationInterfacesBulkPartialUpdate(context.Background()).PatchedWritableVMInterface(patchedWritableVMInterface).Execute()
    if err != nil {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **patchedWritableVMInterface** | [**PatchedWritableVMInterface**](PatchedWritableVMInterface.md) |  | 
...
> VMInterface VirtualizationInterfacesBulkUpdate(ctx).WritableVMInterface(writableVMInterface).Execute()
...
func main() {
    writableVMInterface := *openapiclient.NewWritableVMInterface("Id_example", "Url_example", "VirtualMachine_example", "Name_example", "Display_example") // WritableVMInterface | 

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.VirtualizationApi.VirtualizationInterfacesBulkUpdate(context.Background()).WritableVMInterface(writableVMInterface).Execute()
    if err != nil {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **writableVMInterface** | [**WritableVMInterface**](WritableVMInterface.md) |  | 
...
> VMInterface VirtualizationInterfacesCreate(ctx).WritableVMInterface(writableVMInterface).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.VirtualizationApi.VirtualizationInterfacesCreate(context.Background()).WritableVMInterface(writableVMInterface).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.VirtualizationApi.VirtualizationInterfacesDestroy(context.Background(), id).Execute()
    if err != nil {
...
> PaginatedVMInterfaceList VirtualizationInterfacesList(ctx).Cluster(cluster).ClusterN(clusterN).ClusterId(clusterId).ClusterIdN(clusterIdN).Enabled(enabled).Id(id).IdIc(idIc).IdIe(idIe).IdIew(idIew).IdIre(idIre).IdIsw(idIsw).IdN(idN).IdNic(idNic).IdNie(idNie).IdNiew(idNiew).IdNire(idNire).IdNisw(idNisw).IdNre(idNre).IdRe(idRe).Limit(limit).MacAddress(macAddress).MacAddressIc(macAddressIc).MacAddressIe(macAddressIe).MacAddressIew(macAddressIew).MacAddressIre(macAddressIre).MacAddressIsw(macAddressIsw).MacAddressN(macAddressN).MacAddressNic(macAddressNic).MacAddressNie(macAddressNie).MacAddressNiew(macAddressNiew).MacAddressNire(macAddressNire).MacAddressNisw(macAddressNisw).MacAddressNre(macAddressNre).MacAddressRe(macAddressRe).Mtu(mtu).MtuGt(mtuGt).MtuGte(mtuGte).MtuLt(mtuLt).MtuLte(mtuLte).MtuN(mtuN).Name(name).NameIc(nameIc).NameIe(nameIe).NameIew(nameIew).NameIre(nameIre).NameIsw(nameIsw).NameN(nameN).NameNic(nameNic).NameNie(nameNie).NameNiew(nameNiew).NameNire(nameNire).NameNisw(nameNisw).NameNre(nameNre).NameRe(nameRe).Offset(offset).Q(q).Tag(tag).TagN(tagN).VirtualMachine(virtualMachine).VirtualMachineN(virtualMachineN).VirtualMachineId(virtualMachineId).VirtualMachineIdN(virtualMachineIdN).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.VirtualizationApi.VirtualizationInterfacesList(context.Background()).Cluster(cluster).ClusterN(clusterN).ClusterId(clusterId).ClusterIdN(clusterIdN).Enabled(enabled).Id(id).IdIc(idIc).IdIe(idIe).IdIew(idIew).IdIre(idIre).IdIsw(idIsw).IdN(idN).IdNic(idNic).IdNie(idNie).IdNiew(idNiew).IdNire(idNire).IdNisw(idNisw).IdNre(idNre).IdRe(idRe).Limit(limit).MacAddress(macAddress).MacAddressIc(macAddressIc).MacAddressIe(macAddressIe).MacAddressIew(macAddressIew).MacAddressIre(macAddressIre).MacAddressIsw(macAddressIsw).MacAddressN(macAddressN).MacAddressNic(macAddressNic).MacAddressNie(macAddressNie).MacAddressNiew(macAddressNiew).MacAddressNire(macAddressNire).MacAddressNisw(macAddressNisw).MacAddressNre(macAddressNre).MacAddressRe(macAddressRe).Mtu(mtu).MtuGt(mtuGt).MtuGte(mtuGte).MtuLt(mtuLt).MtuLte(mtuLte).MtuN(mtuN).Name(name).NameIc(nameIc).NameIe(nameIe).NameIew(nameIew).NameIre(nameIre).NameIsw(nameIsw).NameN(nameN).NameNic(nameNic).NameNie(nameNie).NameNiew(nameNiew).NameNire(nameNire).NameNisw(nameNisw).NameNre(nameNre).NameRe(nameRe).Offset(offset).Q(q).Tag(tag).TagN(tagN).VirtualMachine(virtualMachine).VirtualMachineN(virtualMachineN).VirtualMachineId(virtualMachineId).VirtualMachineIdN(virtualMachineIdN).Execute()
    if err != nil {
...
> VMInterface VirtualizationInterfacesPartialUpdate(ctx, id).PatchedWritableVMInterface(patchedWritableVMInterface).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.VirtualizationApi.VirtualizationInterfacesPartialUpdate(context.Background(), id).PatchedWritableVMInterface(patchedWritableVMInterface).Execute()
    if err != nil {
...
> VMInterface VirtualizationInterfacesUpdate(ctx, id).WritableVMInterface(writableVMInterface).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.VirtualizationApi.VirtualizationInterfacesUpdate(context.Background(), id).WritableVMInterface(writableVMInterface).Execute()
    if err != nil {
...
> VirtualizationVirtualMachinesBulkDestroy(ctx).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.VirtualizationApi.VirtualizationVirtualMachinesBulkDestroy(context.Background()).Execute()
    if err != nil {
...
> VirtualMachineWithConfigContext VirtualizationVirtualMachinesBulkPartialUpdate(ctx).PatchedWritableVirtualMachineWithConfigContext(patchedWritableVirtualMachineWithConfigContext).Execute()
...
func main() {
    patchedWritableVirtualMachineWithConfigContext := *openapiclient.NewPatchedWritableVirtualMachineWithConfigContext() // PatchedWritableVirtualMachineWithConfigContext |  (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.VirtualizationApi.VirtualizationVirtualMachinesBulkPartialUpdate(context.Background()).PatchedWritableVirtualMachineWithConfigContext(patchedWritableVirtualMachineWithConfigContext).Execute()
    if err != nil {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **patchedWritableVirtualMachineWithConfigContext** | [**PatchedWritableVirtualMachineWithConfigContext**](PatchedWritableVirtualMachineWithConfigContext.md) |  | 
...
> VirtualMachineWithConfigContext VirtualizationVirtualMachinesBulkUpdate(ctx).WritableVirtualMachineWithConfigContext(writableVirtualMachineWithConfigContext).Execute()
...
func main() {
    writableVirtualMachineWithConfigContext := *openapiclient.NewWritableVirtualMachineWithConfigContext("Id_example", "Url_example", "Name_example", openapiclient.WritableVirtualMachineWithConfigContextStatusEnum("active"), *openapiclient.NewPatchedWritableVirtualMachineWithConfigContextSite("Id_example", "Url_example", "Name_example", "Display_example"), "Cluster_example", *openapiclient.NewDevicePrimaryIp("Id_example", "Url_example", int32(123), "Address_example", "Display_example"), map[string]interface{}{"key": interface{}(123)}, time.Now(), time.Now(), "Display_example") // WritableVirtualMachineWithConfigContext | 

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.VirtualizationApi.VirtualizationVirtualMachinesBulkUpdate(context.Background()).WritableVirtualMachineWithConfigContext(writableVirtualMachineWithConfigContext).Execute()
    if err != nil {
...
> VirtualMachineWithConfigContext VirtualizationVirtualMachinesCreate(ctx).WritableVirtualMachineWithConfigContext(writableVirtualMachineWithConfigContext).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.VirtualizationApi.VirtualizationVirtualMachinesCreate(context.Background()).WritableVirtualMachineWithConfigContext(writableVirtualMachineWithConfigContext).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.VirtualizationApi.VirtualizationVirtualMachinesDestroy(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    clusterGroupId := []string{"Inner_example"} // []string | Cluster group (ID) (optional)
    clusterGroupIdN := []string{"Inner_example"} // []string | Cluster group (ID) (optional)
    clusterId := []string{"Inner_example"} // []string | Cluster (ID) (optional)
    clusterIdN := []string{"Inner_example"} // []string | Cluster (ID) (optional)
    ...
    clusterTypeId := []string{"Inner_example"} // []string | Cluster type (ID) (optional)
    clusterTypeIdN := []string{"Inner_example"} // []string | Cluster type (ID) (optional)
    created := time.Now() // string |  (optional)
    createdGte := time.Now() // string |  (optional)
    createdLte := time.Now() // string |  (optional)
 ...
 **clusterGroupId** | **[]string** | Cluster group (ID) | 
 **clusterGroupIdN** | **[]string** | Cluster group (ID) | 
 **clusterId** | **[]string** | Cluster (ID) | 
 **clusterIdN** | **[]string** | Cluster (ID) | 
 **clusterType** | **[]string** | Cluster type (slug) | 
 **clusterTypeN** | **[]string** | Cluster type (slug) | 
 **clusterTypeId** | **[]string** | Cluster type (ID) | 
 **clusterTypeIdN** | **[]string** | Cluster type (ID) | 
 **created** | **string** |  | 
 **createdGte** | **string** |  | 
 **createdLte** | **string** |  | 
 **disk** | **[]int32** |  | 
...
> VirtualMachineWithConfigContext VirtualizationVirtualMachinesPartialUpdate(ctx, id).PatchedWritableVirtualMachineWithConfigContext(patchedWritableVirtualMachineWithConfigContext).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.VirtualizationApi.VirtualizationVirtualMachinesPartialUpdate(context.Background(), id).PatchedWritableVirtualMachineWithConfigContext(patchedWritableVirtualMachineWithConfigContext).Execute()
    if err != nil {
...
> VirtualMachineWithConfigContext VirtualizationVirtualMachinesUpdate(ctx, id).WritableVirtualMachineWithConfigContext(writableVirtualMachineWithConfigContext).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.VirtualizationApi.VirtualizationVirtualMachinesUpdate(context.Background(), id).WritableVirtualMachineWithConfigContext(writableVirtualMachineWithConfigContext).Execute()
    if err != nil {

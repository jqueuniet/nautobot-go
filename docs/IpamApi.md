...
> IpamIpAddressesBulkDestroy(ctx).Execute()
...
> IPAddressSerializerLegacy IpamIpAddressesRetrieve(ctx, id).Execute()
...
> PaginatedAvailableIPList IpamPrefixesAvailableIpsList(ctx, id).Limit(limit).Offset(offset).Execute()
...
> IpamPrefixesBulkDestroy(ctx).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamPrefixesBulkDestroy(context.Background()).Execute()
    if err != nil {
...
> Prefix IpamPrefixesBulkPartialUpdate(ctx).PatchedWritablePrefix(patchedWritablePrefix).Execute()
...
func main() {
    patchedWritablePrefix := *openapiclient.NewPatchedWritablePrefix() // PatchedWritablePrefix |  (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamPrefixesBulkPartialUpdate(context.Background()).PatchedWritablePrefix(patchedWritablePrefix).Execute()
    if err != nil {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **patchedWritablePrefix** | [**PatchedWritablePrefix**](PatchedWritablePrefix.md) |  | 
...
> Prefix IpamPrefixesBulkUpdate(ctx).WritablePrefix(writablePrefix).Execute()
...
func main() {
    writablePrefix := *openapiclient.NewWritablePrefix("Id_example", "Url_example", "TODO", "Prefix_example", openapiclient.WritablePrefixStatusEnum("active"), time.Now(), time.Now(), map[string]interface{}{"key": interface{}(123)}, "Display_example") // WritablePrefix | 

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamPrefixesBulkUpdate(context.Background()).WritablePrefix(writablePrefix).Execute()
    if err != nil {
...
> Prefix IpamPrefixesCreate(ctx).WritablePrefix(writablePrefix).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamPrefixesCreate(context.Background()).WritablePrefix(writablePrefix).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamPrefixesDestroy(context.Background(), id).Execute()
    if err != nil {
...
> PaginatedPrefixList IpamPrefixesList(ctx).Contains(contains).Created(created).CreatedGte(createdGte).CreatedLte(createdLte).Family(family).Id(id).IdIc(idIc).IdIe(idIe).IdIew(idIew).IdIre(idIre).IdIsw(idIsw).IdN(idN).IdNic(idNic).IdNie(idNie).IdNiew(idNiew).IdNire(idNire).IdNisw(idNisw).IdNre(idNre).IdRe(idRe).IsPool(isPool).LastUpdated(lastUpdated).LastUpdatedGte(lastUpdatedGte).LastUpdatedLte(lastUpdatedLte).Limit(limit).MaskLength(maskLength).MaskLengthGte(maskLengthGte).MaskLengthLte(maskLengthLte).Offset(offset).Prefix(prefix).PresentInVrf(presentInVrf).PresentInVrfId(presentInVrfId).Q(q).Region(region).RegionN(regionN).RegionId(regionId).RegionIdN(regionIdN).Role(role).RoleN(roleN).RoleId(roleId).RoleIdN(roleIdN).Site(site).SiteN(siteN).SiteId(siteId).SiteIdN(siteIdN).Status(status).StatusN(statusN).Tag(tag).TagN(tagN).Tenant(tenant).TenantN(tenantN).TenantGroup(tenantGroup).TenantGroupN(tenantGroupN).TenantGroupId(tenantGroupId).TenantGroupIdN(tenantGroupIdN).TenantId(tenantId).TenantIdN(tenantIdN).VlanId(vlanId).VlanIdN(vlanIdN).VlanVid(vlanVid).Vrf(vrf).VrfN(vrfN).VrfId(vrfId).VrfIdN(vrfIdN).Within(within).WithinInclude(withinInclude).Execute()
...
func main() {
    ...
    lastUpdatedLte := time.Now() // time.Time |  (optional)
    limit := int32(56) // int32 | Number of results to return per page. (optional)
    maskLength := float32(8.14) // float32 | mask_length (optional)
    maskLengthGte := float32(8.14) // float32 | mask_length__gte (optional)
    maskLengthLte := float32(8.14) // float32 | mask_length__lte (optional)
    offset := int32(56) // int32 | The initial index from which to return the results. (optional)
    prefix := "prefix_example" // string | Prefix (optional)
    presentInVrf := "presentInVrf_example" // string | VRF (RD) (optional)
    presentInVrfId := "38400000-8cf0-11bd-b23e-10b96e4ef00d" // string | VRF (optional)
    ...
    vlanIdN := []*string{"Inner_example"} // []*string | VLAN (ID) (optional)
    vlanVid := int32(56) // int32 | VLAN number (1-4095) (optional)
    vrf := []*string{"Inner_example"} // []*string | VRF (RD) (optional)
    vrfN := []*string{"Inner_example"} // []*string | VRF (RD) (optional)
    vrfId := []*string{"Inner_example"} // []*string | VRF (optional)
    vrfIdN := []*string{"Inner_example"} // []*string | VRF (optional)
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamPrefixesList(context.Background()).Contains(contains).Created(created).CreatedGte(createdGte).CreatedLte(createdLte).Family(family).Id(id).IdIc(idIc).IdIe(idIe).IdIew(idIew).IdIre(idIre).IdIsw(idIsw).IdN(idN).IdNic(idNic).IdNie(idNie).IdNiew(idNiew).IdNire(idNire).IdNisw(idNisw).IdNre(idNre).IdRe(idRe).IsPool(isPool).LastUpdated(lastUpdated).LastUpdatedGte(lastUpdatedGte).LastUpdatedLte(lastUpdatedLte).Limit(limit).MaskLength(maskLength).MaskLengthGte(maskLengthGte).MaskLengthLte(maskLengthLte).Offset(offset).Prefix(prefix).PresentInVrf(presentInVrf).PresentInVrfId(presentInVrfId).Q(q).Region(region).RegionN(regionN).RegionId(regionId).RegionIdN(regionIdN).Role(role).RoleN(roleN).RoleId(roleId).RoleIdN(roleIdN).Site(site).SiteN(siteN).SiteId(siteId).SiteIdN(siteIdN).Status(status).StatusN(statusN).Tag(tag).TagN(tagN).Tenant(tenant).TenantN(tenantN).TenantGroup(tenantGroup).TenantGroupN(tenantGroupN).TenantGroupId(tenantGroupId).TenantGroupIdN(tenantGroupIdN).TenantId(tenantId).TenantIdN(tenantIdN).VlanId(vlanId).VlanIdN(vlanIdN).VlanVid(vlanVid).Vrf(vrf).VrfN(vrfN).VrfId(vrfId).VrfIdN(vrfIdN).Within(within).WithinInclude(withinInclude).Execute()
    if err != nil {
 ...
 **lastUpdatedLte** | **time.Time** |  | 
 **limit** | **int32** | Number of results to return per page. | 
 **maskLength** | **float32** | mask_length | 
 **maskLengthGte** | **float32** | mask_length__gte | 
 **maskLengthLte** | **float32** | mask_length__lte | 
 **offset** | **int32** | The initial index from which to return the results. | 
 **prefix** | **string** | Prefix | 
 **presentInVrf** | **string** | VRF (RD) | 
 **presentInVrfId** | **string** | VRF | 
...
> Prefix IpamPrefixesPartialUpdate(ctx, id).PatchedWritablePrefix(patchedWritablePrefix).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamPrefixesPartialUpdate(context.Background(), id).PatchedWritablePrefix(patchedWritablePrefix).Execute()
    if err != nil {
...
> Prefix IpamPrefixesUpdate(ctx, id).WritablePrefix(writablePrefix).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamPrefixesUpdate(context.Background(), id).WritablePrefix(writablePrefix).Execute()
    if err != nil {
...
> IpamRirsBulkDestroy(ctx).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamRirsBulkDestroy(context.Background()).Execute()
    if err != nil {
...
> RIR IpamRirsBulkPartialUpdate(ctx).PatchedRIR(patchedRIR).Execute()
...
func main() {
    patchedRIR := *openapiclient.NewPatchedRIR() // PatchedRIR |  (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamRirsBulkPartialUpdate(context.Background()).PatchedRIR(patchedRIR).Execute()
    if err != nil {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **patchedRIR** | [**PatchedRIR**](PatchedRIR.md) |  | 
...
> RIR IpamRirsBulkUpdate(ctx).RIR(rIR).Execute()
...
func main() {
    rIR := *openapiclient.NewRIR("Id_example", "Url_example", "Name_example", int32(123), time.Now(), time.Now(), "Display_example") // RIR | 

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamRirsBulkUpdate(context.Background()).RIR(rIR).Execute()
    if err != nil {
...
> RIR IpamRirsCreate(ctx).RIR(rIR).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamRirsCreate(context.Background()).RIR(rIR).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamRirsDestroy(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamRirsList(context.Background()).Created(created).CreatedGte(createdGte).CreatedLte(createdLte).Description(description).DescriptionIc(descriptionIc).DescriptionIe(descriptionIe).DescriptionIew(descriptionIew).DescriptionIre(descriptionIre).DescriptionIsw(descriptionIsw).DescriptionN(descriptionN).DescriptionNic(descriptionNic).DescriptionNie(descriptionNie).DescriptionNiew(descriptionNiew).DescriptionNire(descriptionNire).DescriptionNisw(descriptionNisw).DescriptionNre(descriptionNre).DescriptionRe(descriptionRe).Id(id).IdIc(idIc).IdIe(idIe).IdIew(idIew).IdIre(idIre).IdIsw(idIsw).IdN(idN).IdNic(idNic).IdNie(idNie).IdNiew(idNiew).IdNire(idNire).IdNisw(idNisw).IdNre(idNre).IdRe(idRe).IsPrivate(isPrivate).LastUpdated(lastUpdated).LastUpdatedGte(lastUpdatedGte).LastUpdatedLte(lastUpdatedLte).Limit(limit).Name(name).NameIc(nameIc).NameIe(nameIe).NameIew(nameIew).NameIre(nameIre).NameIsw(nameIsw).NameN(nameN).NameNic(nameNic).NameNie(nameNie).NameNiew(nameNiew).NameNire(nameNire).NameNisw(nameNisw).NameNre(nameNre).NameRe(nameRe).Offset(offset).Q(q).Slug(slug).SlugIc(slugIc).SlugIe(slugIe).SlugIew(slugIew).SlugIre(slugIre).SlugIsw(slugIsw).SlugN(slugN).SlugNic(slugNic).SlugNie(slugNie).SlugNiew(slugNiew).SlugNire(slugNire).SlugNisw(slugNisw).SlugNre(slugNre).SlugRe(slugRe).Execute()
    if err != nil {
...
> RIR IpamRirsPartialUpdate(ctx, id).PatchedRIR(patchedRIR).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamRirsPartialUpdate(context.Background(), id).PatchedRIR(patchedRIR).Execute()
    if err != nil {
...
> RIR IpamRirsUpdate(ctx, id).RIR(rIR).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamRirsUpdate(context.Background(), id).RIR(rIR).Execute()
    if err != nil {
...
> IpamRolesBulkDestroy(ctx).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamRolesBulkDestroy(context.Background()).Execute()
    if err != nil {
...
> Role IpamRolesBulkPartialUpdate(ctx).PatchedRole(patchedRole).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamRolesBulkPartialUpdate(context.Background()).PatchedRole(patchedRole).Execute()
    if err != nil {
...
> Role IpamRolesBulkUpdate(ctx).Role(role).Execute()
...
func main() {
    role := *openapiclient.NewRole("Id_example", "Url_example", "Name_example", int32(123), int32(123), time.Now(), time.Now(), "Display_example") // Role | 

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamRolesBulkUpdate(context.Background()).Role(role).Execute()
    if err != nil {
...
> Role IpamRolesCreate(ctx).Role(role).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamRolesCreate(context.Background()).Role(role).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamRolesDestroy(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamRolesList(context.Background()).Created(created).CreatedGte(createdGte).CreatedLte(createdLte).Id(id).IdIc(idIc).IdIe(idIe).IdIew(idIew).IdIre(idIre).IdIsw(idIsw).IdN(idN).IdNic(idNic).IdNie(idNie).IdNiew(idNiew).IdNire(idNire).IdNisw(idNisw).IdNre(idNre).IdRe(idRe).LastUpdated(lastUpdated).LastUpdatedGte(lastUpdatedGte).LastUpdatedLte(lastUpdatedLte).Limit(limit).Name(name).NameIc(nameIc).NameIe(nameIe).NameIew(nameIew).NameIre(nameIre).NameIsw(nameIsw).NameN(nameN).NameNic(nameNic).NameNie(nameNie).NameNiew(nameNiew).NameNire(nameNire).NameNisw(nameNisw).NameNre(nameNre).NameRe(nameRe).Offset(offset).Q(q).Slug(slug).SlugIc(slugIc).SlugIe(slugIe).SlugIew(slugIew).SlugIre(slugIre).SlugIsw(slugIsw).SlugN(slugN).SlugNic(slugNic).SlugNie(slugNie).SlugNiew(slugNiew).SlugNire(slugNire).SlugNisw(slugNisw).SlugNre(slugNre).SlugRe(slugRe).Execute()
    if err != nil {
...
> Role IpamRolesPartialUpdate(ctx, id).PatchedRole(patchedRole).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamRolesPartialUpdate(context.Background(), id).PatchedRole(patchedRole).Execute()
    if err != nil {
...
> Role IpamRolesUpdate(ctx, id).Role(role).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamRolesUpdate(context.Background(), id).Role(role).Execute()
    if err != nil {
...
> IpamRouteTargetsBulkDestroy(ctx).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamRouteTargetsBulkDestroy(context.Background()).Execute()
    if err != nil {
...
> RouteTarget IpamRouteTargetsBulkPartialUpdate(ctx).PatchedWritableRouteTarget(patchedWritableRouteTarget).Execute()
...
func main() {
    patchedWritableRouteTarget := *openapiclient.NewPatchedWritableRouteTarget() // PatchedWritableRouteTarget |  (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamRouteTargetsBulkPartialUpdate(context.Background()).PatchedWritableRouteTarget(patchedWritableRouteTarget).Execute()
    if err != nil {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **patchedWritableRouteTarget** | [**PatchedWritableRouteTarget**](PatchedWritableRouteTarget.md) |  | 
...
> RouteTarget IpamRouteTargetsBulkUpdate(ctx).WritableRouteTarget(writableRouteTarget).Execute()
...
func main() {
    writableRouteTarget := *openapiclient.NewWritableRouteTarget("Id_example", "Url_example", "Name_example", time.Now(), time.Now(), map[string]interface{}{"key": interface{}(123)}, "Display_example") // WritableRouteTarget | 

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamRouteTargetsBulkUpdate(context.Background()).WritableRouteTarget(writableRouteTarget).Execute()
    if err != nil {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **writableRouteTarget** | [**WritableRouteTarget**](WritableRouteTarget.md) |  | 
...
> RouteTarget IpamRouteTargetsCreate(ctx).WritableRouteTarget(writableRouteTarget).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamRouteTargetsCreate(context.Background()).WritableRouteTarget(writableRouteTarget).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamRouteTargetsDestroy(context.Background(), id).Execute()
    if err != nil {
...
> PaginatedRouteTargetList IpamRouteTargetsList(ctx).Created(created).CreatedGte(createdGte).CreatedLte(createdLte).ExportingVrf(exportingVrf).ExportingVrfN(exportingVrfN).ExportingVrfId(exportingVrfId).ExportingVrfIdN(exportingVrfIdN).Id(id).IdIc(idIc).IdIe(idIe).IdIew(idIew).IdIre(idIre).IdIsw(idIsw).IdN(idN).IdNic(idNic).IdNie(idNie).IdNiew(idNiew).IdNire(idNire).IdNisw(idNisw).IdNre(idNre).IdRe(idRe).ImportingVrf(importingVrf).ImportingVrfN(importingVrfN).ImportingVrfId(importingVrfId).ImportingVrfIdN(importingVrfIdN).LastUpdated(lastUpdated).LastUpdatedGte(lastUpdatedGte).LastUpdatedLte(lastUpdatedLte).Limit(limit).Name(name).NameIc(nameIc).NameIe(nameIe).NameIew(nameIew).NameIre(nameIre).NameIsw(nameIsw).NameN(nameN).NameNic(nameNic).NameNie(nameNie).NameNiew(nameNiew).NameNire(nameNire).NameNisw(nameNisw).NameNre(nameNre).NameRe(nameRe).Offset(offset).Q(q).Tag(tag).TagN(tagN).Tenant(tenant).TenantN(tenantN).TenantGroup(tenantGroup).TenantGroupN(tenantGroupN).TenantGroupId(tenantGroupId).TenantGroupIdN(tenantGroupIdN).TenantId(tenantId).TenantIdN(tenantIdN).Execute()
...
func main() {
    ...
    exportingVrfId := []string{"Inner_example"} // []string | Exporting VRF (optional)
    exportingVrfIdN := []string{"Inner_example"} // []string | Exporting VRF (optional)
    id := []string{"Inner_example"} // []string |  (optional)
    idIc := []string{"Inner_example"} // []string |  (optional)
    idIe := []string{"Inner_example"} // []string |  (optional)
    idIew := []string{"Inner_example"} // []string |  (optional)
    ...
    importingVrfId := []string{"Inner_example"} // []string | Importing VRF (optional)
    importingVrfIdN := []string{"Inner_example"} // []string | Importing VRF (optional)
    lastUpdated := time.Now() // time.Time |  (optional)
    lastUpdatedGte := time.Now() // time.Time |  (optional)
    lastUpdatedLte := time.Now() // time.Time |  (optional)
    limit := int32(56) // int32 | Number of results to return per page. (optional)
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamRouteTargetsList(context.Background()).Created(created).CreatedGte(createdGte).CreatedLte(createdLte).ExportingVrf(exportingVrf).ExportingVrfN(exportingVrfN).ExportingVrfId(exportingVrfId).ExportingVrfIdN(exportingVrfIdN).Id(id).IdIc(idIc).IdIe(idIe).IdIew(idIew).IdIre(idIre).IdIsw(idIsw).IdN(idN).IdNic(idNic).IdNie(idNie).IdNiew(idNiew).IdNire(idNire).IdNisw(idNisw).IdNre(idNre).IdRe(idRe).ImportingVrf(importingVrf).ImportingVrfN(importingVrfN).ImportingVrfId(importingVrfId).ImportingVrfIdN(importingVrfIdN).LastUpdated(lastUpdated).LastUpdatedGte(lastUpdatedGte).LastUpdatedLte(lastUpdatedLte).Limit(limit).Name(name).NameIc(nameIc).NameIe(nameIe).NameIew(nameIew).NameIre(nameIre).NameIsw(nameIsw).NameN(nameN).NameNic(nameNic).NameNie(nameNie).NameNiew(nameNiew).NameNire(nameNire).NameNisw(nameNisw).NameNre(nameNre).NameRe(nameRe).Offset(offset).Q(q).Tag(tag).TagN(tagN).Tenant(tenant).TenantN(tenantN).TenantGroup(tenantGroup).TenantGroupN(tenantGroupN).TenantGroupId(tenantGroupId).TenantGroupIdN(tenantGroupIdN).TenantId(tenantId).TenantIdN(tenantIdN).Execute()
    if err != nil {
 ...
 **exportingVrfId** | **[]string** | Exporting VRF | 
 **exportingVrfIdN** | **[]string** | Exporting VRF | 
 **id** | **[]string** |  | 
 **idIc** | **[]string** |  | 
 **idIe** | **[]string** |  | 
 **idIew** | **[]string** |  | 
 ...
 **importingVrfId** | **[]string** | Importing VRF | 
 **importingVrfIdN** | **[]string** | Importing VRF | 
 **lastUpdated** | **time.Time** |  | 
 **lastUpdatedGte** | **time.Time** |  | 
 **lastUpdatedLte** | **time.Time** |  | 
 **limit** | **int32** | Number of results to return per page. | 
...
> RouteTarget IpamRouteTargetsPartialUpdate(ctx, id).PatchedWritableRouteTarget(patchedWritableRouteTarget).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamRouteTargetsPartialUpdate(context.Background(), id).PatchedWritableRouteTarget(patchedWritableRouteTarget).Execute()
    if err != nil {
...
> RouteTarget IpamRouteTargetsUpdate(ctx, id).WritableRouteTarget(writableRouteTarget).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamRouteTargetsUpdate(context.Background(), id).WritableRouteTarget(writableRouteTarget).Execute()
    if err != nil {
...
> IpamServicesBulkDestroy(ctx).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamServicesBulkDestroy(context.Background()).Execute()
    if err != nil {
...
> Service IpamServicesBulkPartialUpdate(ctx).PatchedWritableService(patchedWritableService).Execute()
...
func main() {
    patchedWritableService := *openapiclient.NewPatchedWritableService() // PatchedWritableService |  (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamServicesBulkPartialUpdate(context.Background()).PatchedWritableService(patchedWritableService).Execute()
    if err != nil {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **patchedWritableService** | [**PatchedWritableService**](PatchedWritableService.md) |  | 
...
> Service IpamServicesBulkUpdate(ctx).WritableService(writableService).Execute()
...
func main() {
    writableService := *openapiclient.NewWritableService("Id_example", "Url_example", "Name_example", []int32{int32(123)}, openapiclient.ProtocolEnum("tcp"), time.Now(), time.Now(), map[string]interface{}{"key": interface{}(123)}, "Display_example") // WritableService | 

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamServicesBulkUpdate(context.Background()).WritableService(writableService).Execute()
    if err != nil {
...
> Service IpamServicesCreate(ctx).WritableService(writableService).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamServicesCreate(context.Background()).WritableService(writableService).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamServicesDestroy(context.Background(), id).Execute()
    if err != nil {
...
> PaginatedServiceList IpamServicesList(ctx).Created(created).CreatedGte(createdGte).CreatedLte(createdLte).Device(device).DeviceN(deviceN).DeviceId(deviceId).DeviceIdN(deviceIdN).Id(id).IdIc(idIc).IdIe(idIe).IdIew(idIew).IdIre(idIre).IdIsw(idIsw).IdN(idN).IdNic(idNic).IdNie(idNie).IdNiew(idNiew).IdNire(idNire).IdNisw(idNisw).IdNre(idNre).IdRe(idRe).LastUpdated(lastUpdated).LastUpdatedGte(lastUpdatedGte).LastUpdatedLte(lastUpdatedLte).Limit(limit).Name(name).NameIc(nameIc).NameIe(nameIe).NameIew(nameIew).NameIre(nameIre).NameIsw(nameIsw).NameN(nameN).NameNic(nameNic).NameNie(nameNie).NameNiew(nameNiew).NameNire(nameNire).NameNisw(nameNisw).NameNre(nameNre).NameRe(nameRe).Offset(offset).Port(port).Protocol(protocol).ProtocolN(protocolN).Q(q).Tag(tag).TagN(tagN).VirtualMachine(virtualMachine).VirtualMachineN(virtualMachineN).VirtualMachineId(virtualMachineId).VirtualMachineIdN(virtualMachineIdN).Execute()
...
func main() {
    ...
    virtualMachineId := []*string{"Inner_example"} // []*string | Virtual machine (ID) (optional)
    virtualMachineIdN := []*string{"Inner_example"} // []*string | Virtual machine (ID) (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamServicesList(context.Background()).Created(created).CreatedGte(createdGte).CreatedLte(createdLte).Device(device).DeviceN(deviceN).DeviceId(deviceId).DeviceIdN(deviceIdN).Id(id).IdIc(idIc).IdIe(idIe).IdIew(idIew).IdIre(idIre).IdIsw(idIsw).IdN(idN).IdNic(idNic).IdNie(idNie).IdNiew(idNiew).IdNire(idNire).IdNisw(idNisw).IdNre(idNre).IdRe(idRe).LastUpdated(lastUpdated).LastUpdatedGte(lastUpdatedGte).LastUpdatedLte(lastUpdatedLte).Limit(limit).Name(name).NameIc(nameIc).NameIe(nameIe).NameIew(nameIew).NameIre(nameIre).NameIsw(nameIsw).NameN(nameN).NameNic(nameNic).NameNie(nameNie).NameNiew(nameNiew).NameNire(nameNire).NameNisw(nameNisw).NameNre(nameNre).NameRe(nameRe).Offset(offset).Port(port).Protocol(protocol).ProtocolN(protocolN).Q(q).Tag(tag).TagN(tagN).VirtualMachine(virtualMachine).VirtualMachineN(virtualMachineN).VirtualMachineId(virtualMachineId).VirtualMachineIdN(virtualMachineIdN).Execute()
    if err != nil {
 ...
 **virtualMachineId** | **[]string** | Virtual machine (ID) | 
 **virtualMachineIdN** | **[]string** | Virtual machine (ID) | 
...
> Service IpamServicesPartialUpdate(ctx, id).PatchedWritableService(patchedWritableService).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamServicesPartialUpdate(context.Background(), id).PatchedWritableService(patchedWritableService).Execute()
    if err != nil {
...
> Service IpamServicesUpdate(ctx, id).WritableService(writableService).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamServicesUpdate(context.Background(), id).WritableService(writableService).Execute()
    if err != nil {
...
> IpamVlanGroupsBulkDestroy(ctx).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamVlanGroupsBulkDestroy(context.Background()).Execute()
    if err != nil {
...
> VLANGroup IpamVlanGroupsBulkPartialUpdate(ctx).PatchedWritableVLANGroup(patchedWritableVLANGroup).Execute()
...
func main() {
    patchedWritableVLANGroup := *openapiclient.NewPatchedWritableVLANGroup() // PatchedWritableVLANGroup |  (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamVlanGroupsBulkPartialUpdate(context.Background()).PatchedWritableVLANGroup(patchedWritableVLANGroup).Execute()
    if err != nil {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **patchedWritableVLANGroup** | [**PatchedWritableVLANGroup**](PatchedWritableVLANGroup.md) |  | 
...
> VLANGroup IpamVlanGroupsBulkUpdate(ctx).WritableVLANGroup(writableVLANGroup).Execute()
...
func main() {
    writableVLANGroup := *openapiclient.NewWritableVLANGroup("Id_example", "Url_example", "Name_example", int32(123), time.Now(), time.Now(), map[string]interface{}{"key": interface{}(123)}, "Display_example") // WritableVLANGroup | 

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamVlanGroupsBulkUpdate(context.Background()).WritableVLANGroup(writableVLANGroup).Execute()
    if err != nil {
...
> VLANGroup IpamVlanGroupsCreate(ctx).WritableVLANGroup(writableVLANGroup).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamVlanGroupsCreate(context.Background()).WritableVLANGroup(writableVLANGroup).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamVlanGroupsDestroy(context.Background(), id).Execute()
    if err != nil {
...
> VLANGroup IpamVlanGroupsPartialUpdate(ctx, id).PatchedWritableVLANGroup(patchedWritableVLANGroup).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamVlanGroupsPartialUpdate(context.Background(), id).PatchedWritableVLANGroup(patchedWritableVLANGroup).Execute()
    if err != nil {
...
> VLANGroup IpamVlanGroupsUpdate(ctx, id).WritableVLANGroup(writableVLANGroup).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamVlanGroupsUpdate(context.Background(), id).WritableVLANGroup(writableVLANGroup).Execute()
    if err != nil {
...
> IpamVlansBulkDestroy(ctx).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamVlansBulkDestroy(context.Background()).Execute()
    if err != nil {
...
> VLAN IpamVlansBulkPartialUpdate(ctx).PatchedWritableVLAN(patchedWritableVLAN).Execute()
...
func main() {
    patchedWritableVLAN := *openapiclient.NewPatchedWritableVLAN() // PatchedWritableVLAN |  (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamVlansBulkPartialUpdate(context.Background()).PatchedWritableVLAN(patchedWritableVLAN).Execute()
    if err != nil {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **patchedWritableVLAN** | [**PatchedWritableVLAN**](PatchedWritableVLAN.md) |  | 
...
> VLAN IpamVlansBulkUpdate(ctx).WritableVLAN(writableVLAN).Execute()
...
func main() {
    writableVLAN := *openapiclient.NewWritableVLAN("Id_example", "Url_example", int32(123), "Name_example", openapiclient.WritableVLANStatusEnum("active"), time.Now(), time.Now(), int32(123), map[string]interface{}{"key": interface{}(123)}, "Display_example") // WritableVLAN | 

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamVlansBulkUpdate(context.Background()).WritableVLAN(writableVLAN).Execute()
    if err != nil {
...
> VLAN IpamVlansCreate(ctx).WritableVLAN(writableVLAN).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamVlansCreate(context.Background()).WritableVLAN(writableVLAN).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamVlansDestroy(context.Background(), id).Execute()
    if err != nil {
...
> PaginatedVLANList IpamVlansList(ctx).Created(created).CreatedGte(createdGte).CreatedLte(createdLte).Group(group).GroupN(groupN).GroupId(groupId).GroupIdN(groupIdN).Id(id).IdIc(idIc).IdIe(idIe).IdIew(idIew).IdIre(idIre).IdIsw(idIsw).IdN(idN).IdNic(idNic).IdNie(idNie).IdNiew(idNiew).IdNire(idNire).IdNisw(idNisw).IdNre(idNre).IdRe(idRe).LastUpdated(lastUpdated).LastUpdatedGte(lastUpdatedGte).LastUpdatedLte(lastUpdatedLte).Limit(limit).Name(name).NameIc(nameIc).NameIe(nameIe).NameIew(nameIew).NameIre(nameIre).NameIsw(nameIsw).NameN(nameN).NameNic(nameNic).NameNie(nameNie).NameNiew(nameNiew).NameNire(nameNire).NameNisw(nameNisw).NameNre(nameNre).NameRe(nameRe).Offset(offset).Q(q).Region(region).RegionN(regionN).RegionId(regionId).RegionIdN(regionIdN).Role(role).RoleN(roleN).RoleId(roleId).RoleIdN(roleIdN).Site(site).SiteN(siteN).SiteId(siteId).SiteIdN(siteIdN).Status(status).StatusN(statusN).Tag(tag).TagN(tagN).Tenant(tenant).TenantN(tenantN).TenantGroup(tenantGroup).TenantGroupN(tenantGroupN).TenantGroupId(tenantGroupId).TenantGroupIdN(tenantGroupIdN).TenantId(tenantId).TenantIdN(tenantIdN).Vid(vid).VidGt(vidGt).VidGte(vidGte).VidLt(vidLt).VidLte(vidLte).VidN(vidN).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamVlansList(context.Background()).Created(created).CreatedGte(createdGte).CreatedLte(createdLte).Group(group).GroupN(groupN).GroupId(groupId).GroupIdN(groupIdN).Id(id).IdIc(idIc).IdIe(idIe).IdIew(idIew).IdIre(idIre).IdIsw(idIsw).IdN(idN).IdNic(idNic).IdNie(idNie).IdNiew(idNiew).IdNire(idNire).IdNisw(idNisw).IdNre(idNre).IdRe(idRe).LastUpdated(lastUpdated).LastUpdatedGte(lastUpdatedGte).LastUpdatedLte(lastUpdatedLte).Limit(limit).Name(name).NameIc(nameIc).NameIe(nameIe).NameIew(nameIew).NameIre(nameIre).NameIsw(nameIsw).NameN(nameN).NameNic(nameNic).NameNie(nameNie).NameNiew(nameNiew).NameNire(nameNire).NameNisw(nameNisw).NameNre(nameNre).NameRe(nameRe).Offset(offset).Q(q).Region(region).RegionN(regionN).RegionId(regionId).RegionIdN(regionIdN).Role(role).RoleN(roleN).RoleId(roleId).RoleIdN(roleIdN).Site(site).SiteN(siteN).SiteId(siteId).SiteIdN(siteIdN).Status(status).StatusN(statusN).Tag(tag).TagN(tagN).Tenant(tenant).TenantN(tenantN).TenantGroup(tenantGroup).TenantGroupN(tenantGroupN).TenantGroupId(tenantGroupId).TenantGroupIdN(tenantGroupIdN).TenantId(tenantId).TenantIdN(tenantIdN).Vid(vid).VidGt(vidGt).VidGte(vidGte).VidLt(vidLt).VidLte(vidLte).VidN(vidN).Execute()
    if err != nil {
...
> VLAN IpamVlansPartialUpdate(ctx, id).PatchedWritableVLAN(patchedWritableVLAN).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamVlansPartialUpdate(context.Background(), id).PatchedWritableVLAN(patchedWritableVLAN).Execute()
    if err != nil {
...
> VLAN IpamVlansUpdate(ctx, id).WritableVLAN(writableVLAN).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamVlansUpdate(context.Background(), id).WritableVLAN(writableVLAN).Execute()
    if err != nil {
...
> IpamVrfsBulkDestroy(ctx).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamVrfsBulkDestroy(context.Background()).Execute()
    if err != nil {
...
> VRF IpamVrfsBulkPartialUpdate(ctx).PatchedWritableVRF(patchedWritableVRF).Execute()
...
func main() {
    patchedWritableVRF := *openapiclient.NewPatchedWritableVRF() // PatchedWritableVRF |  (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamVrfsBulkPartialUpdate(context.Background()).PatchedWritableVRF(patchedWritableVRF).Execute()
    if err != nil {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **patchedWritableVRF** | [**PatchedWritableVRF**](PatchedWritableVRF.md) |  | 
...
> VRF IpamVrfsBulkUpdate(ctx).WritableVRF(writableVRF).Execute()
...
func main() {
    writableVRF := *openapiclient.NewWritableVRF("Id_example", "Url_example", "Name_example", time.Now(), time.Now(), int32(123), int32(123), map[string]interface{}{"key": interface{}(123)}, "Display_example") // WritableVRF | 

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamVrfsBulkUpdate(context.Background()).WritableVRF(writableVRF).Execute()
    if err != nil {
...
> VRF IpamVrfsCreate(ctx).WritableVRF(writableVRF).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamVrfsCreate(context.Background()).WritableVRF(writableVRF).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamVrfsDestroy(context.Background(), id).Execute()
    if err != nil {
...
> PaginatedVRFList IpamVrfsList(ctx).Created(created).CreatedGte(createdGte).CreatedLte(createdLte).EnforceUnique(enforceUnique).ExportTarget(exportTarget).ExportTargetN(exportTargetN).ExportTargetId(exportTargetId).ExportTargetIdN(exportTargetIdN).Id(id).IdIc(idIc).IdIe(idIe).IdIew(idIew).IdIre(idIre).IdIsw(idIsw).IdN(idN).IdNic(idNic).IdNie(idNie).IdNiew(idNiew).IdNire(idNire).IdNisw(idNisw).IdNre(idNre).IdRe(idRe).ImportTarget(importTarget).ImportTargetN(importTargetN).ImportTargetId(importTargetId).ImportTargetIdN(importTargetIdN).LastUpdated(lastUpdated).LastUpdatedGte(lastUpdatedGte).LastUpdatedLte(lastUpdatedLte).Limit(limit).Name(name).NameIc(nameIc).NameIe(nameIe).NameIew(nameIew).NameIre(nameIre).NameIsw(nameIsw).NameN(nameN).NameNic(nameNic).NameNie(nameNie).NameNiew(nameNiew).NameNire(nameNire).NameNisw(nameNisw).NameNre(nameNre).NameRe(nameRe).Offset(offset).Q(q).Rd(rd).RdIc(rdIc).RdIe(rdIe).RdIew(rdIew).RdIre(rdIre).RdIsw(rdIsw).RdN(rdN).RdNic(rdNic).RdNie(rdNie).RdNiew(rdNiew).RdNire(rdNire).RdNisw(rdNisw).RdNre(rdNre).RdRe(rdRe).Tag(tag).TagN(tagN).Tenant(tenant).TenantN(tenantN).TenantGroup(tenantGroup).TenantGroupN(tenantGroupN).TenantGroupId(tenantGroupId).TenantGroupIdN(tenantGroupIdN).TenantId(tenantId).TenantIdN(tenantIdN).Execute()
...
func main() {
    ...
    exportTargetId := []string{"Inner_example"} // []string | Export target (optional)
    exportTargetIdN := []string{"Inner_example"} // []string | Export target (optional)
    id := []string{"Inner_example"} // []string |  (optional)
    idIc := []string{"Inner_example"} // []string |  (optional)
    idIe := []string{"Inner_example"} // []string |  (optional)
    idIew := []string{"Inner_example"} // []string |  (optional)
    ...
    importTargetId := []string{"Inner_example"} // []string | Import target (optional)
    importTargetIdN := []string{"Inner_example"} // []string | Import target (optional)
    lastUpdated := time.Now() // time.Time |  (optional)
    lastUpdatedGte := time.Now() // time.Time |  (optional)
    lastUpdatedLte := time.Now() // time.Time |  (optional)
    limit := int32(56) // int32 | Number of results to return per page. (optional)
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamVrfsList(context.Background()).Created(created).CreatedGte(createdGte).CreatedLte(createdLte).EnforceUnique(enforceUnique).ExportTarget(exportTarget).ExportTargetN(exportTargetN).ExportTargetId(exportTargetId).ExportTargetIdN(exportTargetIdN).Id(id).IdIc(idIc).IdIe(idIe).IdIew(idIew).IdIre(idIre).IdIsw(idIsw).IdN(idN).IdNic(idNic).IdNie(idNie).IdNiew(idNiew).IdNire(idNire).IdNisw(idNisw).IdNre(idNre).IdRe(idRe).ImportTarget(importTarget).ImportTargetN(importTargetN).ImportTargetId(importTargetId).ImportTargetIdN(importTargetIdN).LastUpdated(lastUpdated).LastUpdatedGte(lastUpdatedGte).LastUpdatedLte(lastUpdatedLte).Limit(limit).Name(name).NameIc(nameIc).NameIe(nameIe).NameIew(nameIew).NameIre(nameIre).NameIsw(nameIsw).NameN(nameN).NameNic(nameNic).NameNie(nameNie).NameNiew(nameNiew).NameNire(nameNire).NameNisw(nameNisw).NameNre(nameNre).NameRe(nameRe).Offset(offset).Q(q).Rd(rd).RdIc(rdIc).RdIe(rdIe).RdIew(rdIew).RdIre(rdIre).RdIsw(rdIsw).RdN(rdN).RdNic(rdNic).RdNie(rdNie).RdNiew(rdNiew).RdNire(rdNire).RdNisw(rdNisw).RdNre(rdNre).RdRe(rdRe).Tag(tag).TagN(tagN).Tenant(tenant).TenantN(tenantN).TenantGroup(tenantGroup).TenantGroupN(tenantGroupN).TenantGroupId(tenantGroupId).TenantGroupIdN(tenantGroupIdN).TenantId(tenantId).TenantIdN(tenantIdN).Execute()
    if err != nil {
 ...
 **exportTargetId** | **[]string** | Export target | 
 **exportTargetIdN** | **[]string** | Export target | 
 **id** | **[]string** |  | 
 **idIc** | **[]string** |  | 
 **idIe** | **[]string** |  | 
 **idIew** | **[]string** |  | 
 ...
 **importTargetId** | **[]string** | Import target | 
 **importTargetIdN** | **[]string** | Import target | 
 **lastUpdated** | **time.Time** |  | 
 **lastUpdatedGte** | **time.Time** |  | 
 **lastUpdatedLte** | **time.Time** |  | 
 **limit** | **int32** | Number of results to return per page. | 
...
> VRF IpamVrfsPartialUpdate(ctx, id).PatchedWritableVRF(patchedWritableVRF).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamVrfsPartialUpdate(context.Background(), id).PatchedWritableVRF(patchedWritableVRF).Execute()
    if err != nil {
...
> VRF IpamVrfsUpdate(ctx, id).WritableVRF(writableVRF).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IpamApi.IpamVrfsUpdate(context.Background(), id).WritableVRF(writableVRF).Execute()
    if err != nil {

...
`func NewUser(id string, url string, username string, password string, display string, ) *User`
...
`func (o *User) GetGroups() []ObjectPermissionGroupsInner`

GetGroups returns the Groups field if non-nil, zero value otherwise.

### GetGroupsOk

`func (o *User) GetGroupsOk() (*[]ObjectPermissionGroupsInner, bool)`
...
`func (o *User) SetGroups(v []ObjectPermissionGroupsInner)`

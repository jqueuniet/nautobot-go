...
// PatchedWritableInterface Extends ModelSerializer to render any CustomFields and their values associated with an object.
...
func (o *PatchedWritableInterface) SetLagNil() {
	o.Lag.Set(nil)
}
...
func (o *PatchedWritableInterface) SetMtuNil() {
	o.Mtu.Set(nil)
}
...
func (o *PatchedWritableInterface) SetMacAddressNil() {
...
func (o *PatchedWritableInterface) SetUntaggedVlanNil() {
...
func (o *PatchedWritableInterface) SetCablePeerTypeNil() {
...
func (o *PatchedWritableInterface) SetConnectedEndpointTypeNil() {
...
func (o *PatchedWritableInterface) SetConnectedEndpointReachableNil() {
...
func (o PatchedWritableInterface) MarshalJSON() ([]byte, error) {
...
type NullablePatchedWritableInterface struct {
	value *PatchedWritableInterface
	isSet bool
}

func (v NullablePatchedWritableInterface) Get() *PatchedWritableInterface {
	return v.value
}

func (v *NullablePatchedWritableInterface) Set(val *PatchedWritableInterface) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedWritableInterface) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedWritableInterface) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedWritableInterface(val *PatchedWritableInterface) *NullablePatchedWritableInterface {
	return &NullablePatchedWritableInterface{value: val, isSet: true}
}

func (v NullablePatchedWritableInterface) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedWritableInterface) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// TenantGroupParent struct for TenantGroupParent
type TenantGroupParent struct {
	Id string `json:"id"`
	Url string `json:"url"`
...
func (o TenantGroupParent) MarshalJSON() ([]byte, error) {
...
type NullableTenantGroupParent struct {
	value *TenantGroupParent
	isSet bool
}

func (v NullableTenantGroupParent) Get() *TenantGroupParent {
	return v.value
}

func (v *NullableTenantGroupParent) Set(val *TenantGroupParent) {
	v.value = val
	v.isSet = true
}

func (v NullableTenantGroupParent) IsSet() bool {
	return v.isSet
}

func (v *NullableTenantGroupParent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTenantGroupParent(val *TenantGroupParent) *NullableTenantGroupParent {
	return &NullableTenantGroupParent{value: val, isSet: true}
}

func (v NullableTenantGroupParent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTenantGroupParent) UnmarshalJSON(src []byte) error {
	v.isSet = true

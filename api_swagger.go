...
func (r ApiSwaggerRetrieveRequest) Format(format string) ApiSwaggerRetrieveRequest {
	r.format = &format
	return r
}

func (r ApiSwaggerRetrieveRequest) Lang(lang string) ApiSwaggerRetrieveRequest {
	r.lang = &lang
	return r
}

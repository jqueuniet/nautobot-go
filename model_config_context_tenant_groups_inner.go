...
// ConfigContextTenantGroupsInner struct for ConfigContextTenantGroupsInner
type ConfigContextTenantGroupsInner struct {
	Id string `json:"id"`
	Url string `json:"url"`
...
func NewConfigContextTenantGroupsInner(id string, url string, name string, tenantCount int32, depth int32, display string) *ConfigContextTenantGroupsInner {
	this := ConfigContextTenantGroupsInner{}
	this.Id = id
	this.Url = url
	this.Name = name
...
func (o ConfigContextTenantGroupsInner) MarshalJSON() ([]byte, error) {
...
type NullableConfigContextTenantGroupsInner struct {
	value *ConfigContextTenantGroupsInner
	isSet bool
}

func (v NullableConfigContextTenantGroupsInner) Get() *ConfigContextTenantGroupsInner {
	return v.value
}

func (v *NullableConfigContextTenantGroupsInner) Set(val *ConfigContextTenantGroupsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableConfigContextTenantGroupsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableConfigContextTenantGroupsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConfigContextTenantGroupsInner(val *ConfigContextTenantGroupsInner) *NullableConfigContextTenantGroupsInner {
	return &NullableConfigContextTenantGroupsInner{value: val, isSet: true}
}

func (v NullableConfigContextTenantGroupsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConfigContextTenantGroupsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true

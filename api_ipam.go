...
type ApiIpamPrefixesAvailableIpsCreateRequest struct {
	...
	ApiService *IpamApiService
	id string
	availableIPAddressRequest *AvailableIPAddressRequest
}

func (r ApiIpamPrefixesAvailableIpsCreateRequest) AvailableIPAddressRequest(availableIPAddressRequest AvailableIPAddressRequest) ApiIpamPrefixesAvailableIpsCreateRequest {
	r.availableIPAddressRequest = &availableIPAddressRequest
	return r
}
...
func (a *IpamApiService) IpamPrefixesAvailableIpsCreateExecute(r ApiIpamPrefixesAvailableIpsCreateRequest) (*IPAddress, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.availableIPAddressRequest == nil {
		return localVarReturnValue, nil, reportError("availableIPAddressRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.availableIPAddressRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["tokenAuth"]; ok {
...
type ApiIpamPrefixesAvailablePrefixesCreateRequest struct {
	...
	ApiService *IpamApiService
	id string
	availablePrefixRequest *AvailablePrefixRequest
}

func (r ApiIpamPrefixesAvailablePrefixesCreateRequest) AvailablePrefixRequest(availablePrefixRequest AvailablePrefixRequest) ApiIpamPrefixesAvailablePrefixesCreateRequest {
	r.availablePrefixRequest = &availablePrefixRequest
	return r
}
...
func (a *IpamApiService) IpamPrefixesAvailablePrefixesCreateExecute(r ApiIpamPrefixesAvailablePrefixesCreateRequest) (*Prefix, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.availablePrefixRequest == nil {
		return localVarReturnValue, nil, reportError("availablePrefixRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.availablePrefixRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["tokenAuth"]; ok {

...
type IPAddressSerializerLegacy struct {
	...
	Status IPAddressSerializerLegacyStatus `json:"status"`
	Role *IPAddressSerializerLegacyRole `json:"role,omitempty"`
...
func (o *IPAddressSerializerLegacy) GetStatus() IPAddressSerializerLegacyStatus {
	if o == nil {
		var ret IPAddressSerializerLegacyStatus
		return ret
	}
...
func (o *IPAddressSerializerLegacy) GetRole() IPAddressSerializerLegacyRole {
	if o == nil || o.Role == nil {
		var ret IPAddressSerializerLegacyRole
		return ret
	}
	return *o.Role
}
...
// SetRole gets a reference to the given IPAddressSerializerLegacyRole and assigns it to the Role field.

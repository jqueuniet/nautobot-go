...
// WritableDeviceWithConfigContext Mixin to add `status` choice field to model serializers.
...
func (o *WritableDeviceWithConfigContext) SetSecretsGroupNil() {
...
func (o *WritableDeviceWithConfigContext) SetLocalContextSchemaNil() {

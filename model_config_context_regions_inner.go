...
// ConfigContextRegionsInner struct for ConfigContextRegionsInner
type ConfigContextRegionsInner struct {
	Id string `json:"id"`
	Url string `json:"url"`
...
func NewConfigContextRegionsInner(id string, url string, name string, siteCount int32, depth int32, display string) *ConfigContextRegionsInner {
	this := ConfigContextRegionsInner{}
	this.Id = id
	this.Url = url
	this.Name = name
...
func (o ConfigContextRegionsInner) MarshalJSON() ([]byte, error) {
...
type NullableConfigContextRegionsInner struct {
	value *ConfigContextRegionsInner
	isSet bool
}

func (v NullableConfigContextRegionsInner) Get() *ConfigContextRegionsInner {
	return v.value
}

func (v *NullableConfigContextRegionsInner) Set(val *ConfigContextRegionsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableConfigContextRegionsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableConfigContextRegionsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConfigContextRegionsInner(val *ConfigContextRegionsInner) *NullableConfigContextRegionsInner {
	return &NullableConfigContextRegionsInner{value: val, isSet: true}
}

func (v NullableConfigContextRegionsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConfigContextRegionsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// PatchedRackRole Extends ModelSerializer to render any CustomFields and their values associated with an object.
...
func (o PatchedRackRole) MarshalJSON() ([]byte, error) {
...
type NullablePatchedRackRole struct {
	value *PatchedRackRole
	isSet bool
}

func (v NullablePatchedRackRole) Get() *PatchedRackRole {
	return v.value
}

func (v *NullablePatchedRackRole) Set(val *PatchedRackRole) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedRackRole) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedRackRole) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedRackRole(val *PatchedRackRole) *NullablePatchedRackRole {
	return &NullablePatchedRackRole{value: val, isSet: true}
}

func (v NullablePatchedRackRole) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedRackRole) UnmarshalJSON(src []byte) error {
	v.isSet = true

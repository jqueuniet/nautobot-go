...
// PaginatedJobClassList struct for PaginatedJobClassList
type PaginatedJobClassList struct {
	Count *int32 `json:"count,omitempty"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results []JobClass `json:"results,omitempty"`
}
...
func (o *PaginatedJobClassList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedJobClassList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []JobClass and assigns it to the Results field.
func (o *PaginatedJobClassList) SetResults(v []JobClass) {
	o.Results = v
}

func (o PaginatedJobClassList) MarshalJSON() ([]byte, error) {
...
type NullablePaginatedJobClassList struct {
	value *PaginatedJobClassList
	isSet bool
}

func (v NullablePaginatedJobClassList) Get() *PaginatedJobClassList {
	return v.value
}

func (v *NullablePaginatedJobClassList) Set(val *PaginatedJobClassList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedJobClassList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedJobClassList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedJobClassList(val *PaginatedJobClassList) *NullablePaginatedJobClassList {
	return &NullablePaginatedJobClassList{value: val, isSet: true}
}

func (v NullablePaginatedJobClassList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedJobClassList) UnmarshalJSON(src []byte) error {
	v.isSet = true
